...
const VERSICULOS = [
  ...
  { text: "Tudo o que é verdadeiro, tudo o que é honesto, tudo o que é justo — nisso pensai.", ref: "Filipenses 4:8" },
  ...
  { text: "Não haja entre vocês ansiedade por coisa alguma, mas em tudo pela oração.", ref: "Filipenses 4:6" },
  // HEBREUS / CARTAS
  ...
  { text: "Sede sóbrios e vigilantes. O diabo, vosso adversário, anda em derredor, como leão que ruge.", ref: "1 Pedro 5:8" },
...
const TIMER_VERSES = [
  ...
  '"Em tudo pela oração e súplica com ações de graças." (Filipenses 4:6)',
...
function shareVerse() {
  ...
  const text = `"${v.text}" (${v.ref})\n\nAposento Alto — aposetoalto.com.br`;
  if (navigator.share) {
